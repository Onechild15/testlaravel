    ...
    @foreach($sharks as $key => $value)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success" href="{{ URL::to('sharks/' . $value->CABANG) }}">Show this shark</a>

                <!-- edit this shark (uses the edit method found at GET /sharks/{id}/edit -->
                <a class="btn btn-small btn-info" href="{{ URL::to('sharks/' . $value->CABANG . '/edit') }}">Edit this shark</a>
